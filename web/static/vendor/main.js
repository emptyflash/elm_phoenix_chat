...
var _user$project$Main$websocketUrl = 'ws://b115756c.ngrok.io/socket/websocket';
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {socket: a, newMessage: b, messages: c, user: d, joined: e};
	});
...
var _user$project$Main$initSocket = A4(
	...
	_fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(_user$project$Main$websocketUrl)));
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'PhoenixMsg':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{socket: socket}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PhoenixMsg, cmd)
				};
			case 'SendMessage':
				var payload = _elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'user',
							_1: _elm_lang$core$Json_Encode$string(model.user)
						},
						_1: {
							ctor: '::',
							_0: {
				...
				var _p2 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push, model.socket);
			...
			case 'ReceiveChatMessage':
				var _p3 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Main$chatMessageDecoder, _p0._0);
				if (_p3.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								messages: {ctor: '::', _0: _p3._0, _1: model.messages}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'JoinChannel':
				...
				var _p4 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join, channel, model.socket);
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{socket: newSocket, joined: true}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PhoenixMsg, cmd)
				};
			case 'LeaveChannel':
				var _p5 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$leave, 'room:lobby', model.socket);
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{socket: newSocket, joined: false}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PhoenixMsg, cmd)
				};
			case 'ShowJoinedMessage':
				var joinedMessage = A2(
					_user$project$Main$ChatMessage,
					'',
					A2(_elm_lang$core$Basics_ops['++'], 'Joined ', _p0._0));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							messages: {ctor: '::', _0: joinedMessage, _1: model.messages}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ShowLeftMessage':
				var leftMessage = A2(
					_user$project$Main$ChatMessage,
					'',
					A2(_elm_lang$core$Basics_ops['++'], 'Left ', _p0._0));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							messages: {ctor: '::', _0: leftMessage, _1: model.messages}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
...
var _user$project$Main$joinForm = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Main$JoinChannel),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$value(model.user),
						_1: {
							ctor: '::',
...
var _user$project$Main$newMessageForm = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		{
			ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$LeaveChannel),
								_1: {ctor: '[]'}
							}
						},
						{
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: model.joined ? _user$project$Main$newMessageForm(model) : _user$project$Main$joinForm(model),
					_1: {ctor: '[]'}
				}
			}
		});
